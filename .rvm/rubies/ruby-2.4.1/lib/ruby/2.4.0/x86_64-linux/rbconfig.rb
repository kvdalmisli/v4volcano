...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/travis/.rvm/rubies/ruby-2.4.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/.rvm/rubies/ruby-2.4.1' '--without-tcl' '--without-tk' '--without-gmp' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
